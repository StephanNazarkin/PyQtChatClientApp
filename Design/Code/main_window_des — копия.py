...
"}")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("design\\uiDesign\\../code/Resources/add_user1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.listWidget.setGeometry(QtCore.QRect(310, 80, 791, 581))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
